...
import { doctorNavItems, doctorAccountItems } from '../doctor/doctor-nav-items.jsx';
...
export default function DoctorSidebar() {
  ...
  return (
    <aside className="w-60 shrink-0 flex flex-col fixed top-0 left-0 h-screen z-[60]" style={{ background: '#1a2332' }}>
      <NavLink to="/" className="px-5 py-6 border-b border-white/10 shrink-0">
