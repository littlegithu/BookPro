        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="grid grid-cols-3 gap-3.5">
            <div className="bg-teal rounded-lg border border-teal p-5">
              <div className="w-8 h-8 rounded-lg text-navy bg-white/15 flex items-center justify-center mb-3.5"><Calendar size={20} /></div>
            ...
            <div className="bg-card rounded-lg border border-border p-5">
              <div className="w-8 h-8 rounded-lg text-slate bg-teal-light flex items-center justify-center mb-3.5"><CheckCircle size={20} /></div>
            ...
            <div className="bg-card rounded-lg border border-border p-5">
              <div className="w-8 h-8 rounded-lg text-slate bg-teal-light flex items-center justify-center mb-3.5"><ClipboardList size={20} /></div>
