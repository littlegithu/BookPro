      ...
      <div className="bg-navy px-15 pt-14 pb-8">
        <div className="max-w-7xl mx-auto grid grid-cols-[2fr_1fr_1fr_1fr] gap-10 mb-10">
          <div>
            ...
            <p className="text-[13px] mt-3 max-w-55 leading-[1.75]" style={{color:'rgba(255,255,255,0.42)'}}>Clinical checkups made simple. Find a verified doctor and book in minutes.</p>
          </div>
          {[
